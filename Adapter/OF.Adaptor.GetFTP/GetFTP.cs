// ***********************************************************************
// Assembly         : OF.Adaptor.GetFTP
// Author           : Peter Kraus
// Created          : 11-01-2025
// ***********************************************************************
// <summary>GetFTP.cs
// Gets files from FTP server and renames them when done
// </summary>
// ***********************************************************************
...
namespace OF.Adapter.GetFTP
{
    ...
    public sealed class GetFTP : MBActivity, IOFModule
    {
        ...
        /// <summary>
        /// The rename when done extension
        /// </summary>
        ...
        public static void RegisterMetadata()
       {
            ...
            builder.AddCustomAttributes(typeof(OF.Adapter.GetFTP.GetFTP), new DesignerAttribute(typeof(OF.Adapter.GetFTP.GetFTPDesigner)));
