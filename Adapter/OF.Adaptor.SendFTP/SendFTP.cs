// ***********************************************************************
// Assembly         : OF.Adaptor.SendFTP
// Author           : Peter Kraus
// Created          : 10-16-2025
// ***********************************************************************
// <summary>SendFTP.cs
// Sends files to server via FTP
// </summary>
// ***********************************************************************
    ...
    public sealed class SendFTP : MBActivity, IOFModule
    {
        ...
        protected override void Execute(NativeActivityContext context)
        {
            ...
            catch (System.Exception ex)
            {
                ...
                throw new OF.Module.OptiFlowException("SendFTP Error. sending file via FTP: " + filename, ex);
            }
        ...
        public static void RegisterMetadata()
       {
            ...
            builder.AddCustomAttributes(typeof(OF.Adapter.SendFTP.SendFTP), new DesignerAttribute(typeof(OF.Adapter.SendFTP.SendFTPDesigner)));
